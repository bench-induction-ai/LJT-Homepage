...
Junteng Liu is a first-year PhD candidate at the **HKUST NLP Group** at the **Hong Kong University of Science and Technology**, supervised by **Professor Junxian He**. Junteng Liu graduated from **Shanghai Jiao Tong University (SJTU)** in June 2024, where Professor Junxian He also advised Junteng Liu during undergraduate studies.
...
1. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond**  
   **Junteng Liu** (first author), Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He.  
   arXiv, 2025. Has a GitHub code repository.
